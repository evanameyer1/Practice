...
# Problem 1
# Check if x is less than 30 and greater than 20
x <- 25
print(x < 30 & x > 20)

# Problem 2
# Check if x is either less than 10 or greater than 30
print(x < 10 | x > 30)
...
# Problem 1
# Create a function that takes a vector as input and returns the sum of its elements
...
# Problem 1
# Create a function that categorizes a student's performance based on the marks
...
# Problem 1
# Create a function that converts a day number (1-7) to the corresponding day name
